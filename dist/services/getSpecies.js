...
var fetchEvolutionChain = function(data) {
    ...
    return __generator(this, function(_c) {
      switch (_c.label) {
        case 0:
          _a = [{}, data];
          _b = {};
          return [4, getEvolutionChain(data.evolution_chain.url)];
        case 1:
          return [2, __assign.apply(void 0, _a.concat([((_b.evolutions = _c.sent()), _b)]))];
      }
    });
  });
};
var getSpecies = function(url) {
  return axios
    .get(url)
