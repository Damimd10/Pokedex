...
const getEvolve = (chain: NormalizedEvolutions[], evolve?: ChainLink): NormalizedEvolutions[] => {
...
const mappingEvolutions = (evolutions: EvolutionChain): NormalizedEvolutions[] => getEvolve([], evolutions.chain)
